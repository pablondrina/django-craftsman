"""
Scheduling service -- plan, approve, schedule, and query operations.
...
class CraftScheduling:
    """
    Planning and scheduling operations.

    Covers the full MPS flow: plan -> approve -> schedule,
    plus direct WorkOrder creation (bypassing MPS).
    """
